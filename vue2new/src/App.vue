<template>
  <div id="app">
    <div class="container">
        <nav class="navber navbar-dark bg-inverse navbar-fixed-top">
            ...
            <ul class="nav navbar-nav">
                ...
                <li class="nav-item">
                    <a href="#" class="nav-link"><i class="fa fa-flag"></i>Hot</a>
                </li>
            </ul>
            <form class="form-inline float-xs-right">
                <input type="text" class="form-control" placeholder="搜索公众号/文章"/>
                <router-link to="/search"><i class="fa fa-search btn btn-outline-success" @slick=""></i></router-link>
            </form>
        </nav>
    </div>
