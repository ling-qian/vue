  ...
  <div class="outer-container">
    ...
    <div class="note-editor">
      ...
      <div class="wrapper-body">
        <quill-editor ref="myTectRditor" v-model="note.content" :config="editorOption" @blur="onEditorBlur($event)" @focus="onEditorFocus($event)" @ready="onEditorReady">
    ...
    mounted () {
      ...
      this.$http.get('/user/isLogin').then(function (response) {
        ...
        if (response.body === '已登录') {
          ...
          this.$store.sidpath('changeIsLogin', false);
