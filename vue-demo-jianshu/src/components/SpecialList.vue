<template>
  <div class="topic_acticle_container">
    <ul>
      <li v-for="content in topicArticles">
        <a href="" class="topic_article_img"><img :src="content.img" alt=""/></a>
        <div class="topic_content">
          <h5></h5>
          <p></p>
          <div class="topic_button"><a href=""><i class="fa fa-fw fa-plus"></i><span>添加关注</span></a></div>
        </div>
        <p>
          <a href="" style="color:#4094c7;">{{ content.number}}篇文章</a>
          &nbsp;&nbsp;·&nbsp;&nbsp;{{content.concern}}k人关注
          <span class="topic_tag"><i class="fa fa-tags"></i>{{ content.keys}}</span></p>
      </li>
    </ul>
  </div>
</template>
