<template>
  <div>
    ...
    <div class="article-page">
      ...
      <div class="hot-img"><img src="../../static/images/hot-special.png" alt=""/></div>
      <div class="article-list">
        <ul class="btn-group">
          <li :cladd="{active: show === 'hot'}" @click="displayTopic('hot')">
            <router-link to="/topic/topic_article/hot">热门</router-link>
          </li>
          <li :cladd="{active: show === 'recommend'}" @click="displayTopic('recommend')">
            <router-link to="/topic/topic_article/recommend">热门</router-link>
          </li>
        </ul>
      </div>
