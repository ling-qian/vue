<template>
  <div class="bonus-container">
    ...
    <Ul class="text-list">
    <li v-for="art in bonuses" :style="{background: art.bg, backgroundSize: '100%', backgroundRepeat: 'no-repeat', backgroundColor:'#fff'}">
      <div class="content">
        <a href="" class="mask">
...
<script>
  ...
  export default {
    ...
    mounted () {
      thid.$store.dispath('changeArticleFlag', true)
    }
  }
</script>
<style>
